const { isAsync } = require('./async.js')

const is = function is (value, compareValue) {
...
const compareTypes = function compareTypes (value, compareValue) {
...
const Primitive = function Primitive () { return Primitive }
Object.defineProperty(Primitive, Symbol.hasInstance, {
  value: isPrimitive,
})

const Any = function Any () { return Any }
...
const isExactType = function isType (type, value) {
...
const isType = function isType (type, value) {
...
const isUndefined = function isUndefined (value) {
  return value === undefined
}

const isNull = function isNull (value) {
  return value === null
}

const isDefined = function isDefined (value) {
  return (value !== undefined) && (value !== null)
}

const isMissing = function isDefined (value) {
  return (value === undefined) || (value === null)
}
...
const isFalsy = function isFalsy (value) {
  return !value
}
...
const isMap = function isMap (value) {
...
const isSet = function isSet (value) {
...
const compare = function compare (value, compareValue) {
...
const comparing = function comparing (resolver) {
  return function comparing (value, compareValue) {
    const v1 = resolver(value)
    const v2 = resolver(compareValue)
...
const equal = function equal (value, compareValue) {
...
module.exports = {
  ...
  strictEqual: is,
  typeOf: constructor,
  sameType: isExactType,
  strictEqualType: isExactType,
  deepEqual: equal,
  eq: equal,
  equalTo: equal,
  constructor,
