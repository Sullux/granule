const { DeepSync, isAsync } = require('./async.js')
const { context } = ('./context.js')

const symbol = Symbol.granule || (Symbol.granule = {})

export const compiledSymbol = symbol.compiled = Symbol.for('granule.compiled')
export const compilerSymbol = symbol.compiler = Symbol.for('granule.compiler')
export const isCompiledSymbol = symbol.isCompiled = Symbol.for('granule.isCompiled')
export const isDefineSymbol = symbol.isDefine = Symbol.for('granule.isDefine')
